...
export const metadata = {
  title: "DOBTech - Get a Second Brain with Generative AI",
  description:
    "DOBTech is your second brain in the cloud, designed to easily store and retrieve unstructured information.",
};
