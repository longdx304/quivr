    ...
    >
      ...
      <div className={styles.content}>
        <div className={styles.section}>
          <span className={styles.title}>
            {t("help_window.build_your_second_brains", { ns: "contact" })}
          </span>
          <span className={styles.section_content}>
            <strong>Brain</strong>{" "}
            {t("help_window.brain_description", { ns: "contact" })}
            <ul>
              <li>
                <strong>
                  {t("help_window.knowledge_integration", { ns: "contact" })}
                </strong>
                <br />
                {t("help_window.connect_to_and_pull_data", { ns: "contact" })}
                ...
                {t("help_window.you_can_also_incorporate_data_from", {
                  ns: "contact",
                })}{" "}
                <strong>URLs</strong> {t("help_window.and", { ns: "contact" })}{" "}
                <strong>files</strong>.
              </li>
              <li>
                <strong>{t("help_window.ai_models", { ns: "contact" })}</strong>
                <br />
                {t("help_window.utilize_powerful_models", { ns: "contact" })}
                <strong>
                  <em>GPT</em>
                </strong>{" "}
                {t("help_window.and", { ns: "contact" })}{" "}
              ...
              <li>
                <strong>
                  {t("help_window.customization", { ns: "contact" })}
                </strong>
                <br />
                {t("help_window.tailor_the_behavior", { ns: "contact" })}{" "}
                <em>{t("help_window.custom_prompts", { ns: "contact" })}</em>{" "}
                {t("help_window.and", { ns: "contact" })}{" "}
                <em>{t("help_window.settings", { ns: "contact" })}</em>,{" "}
                {t("help_window.such_as", { ns: "contact" })}{" "}
                <strong>
                  {t("help_window.max_tokens", { ns: "contact" })}
                </strong>
                ,{" "}
                {t("help_window.to_better_suit_your_needs", { ns: "contact" })}
              </li>
            </ul>
            <p>
              {t("help_window.you_can_also", { ns: "contact" })}
              <strong>{t("help_window.share", { ns: "contact" })}</strong>{" "}
              {t("help_window.your_brains_with_other_Medzavy.AI", {
                ns: "contact",
              })}
            </p>
          </span>
        ...
        <div className={styles.section}>
          <span className={styles.title}>
            {t("help_window.talk_to_ai_models", { ns: "contact" })}
          </span>
          <span className={styles.section_content}>
            <p>
              {t("help_window.Medzavy.AI_allows_you_to", { ns: "contact" })}
              <strong>
                {t("help_window.interact_directly", { ns: "contact" })}
              </strong>{" "}
              {t("help_window.with_ai_models_such_as", { ns: "contact" })}
              <strong>
                <em>GPT-4</em>
              </strong>{" "}
              {t("help_window.and", { ns: "contact" })}
        ...
        <div className={styles.section}>
          <div className={styles.title}>
            {t("help_window.select_assistant", { ns: "contact" })}
          </div>
          <span className={styles.section_content}>
            <p>
              {t("help_window.press", { ns: "contact" })}
              <strong> @</strong>
              {t("help_window.to_choose_the_AI_model", { ns: "contact" })}
            </p>
          </span>
